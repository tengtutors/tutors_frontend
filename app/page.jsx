...
const Page = async () => {
    ...
    return (
        <div className="h-dvh flex items-center justify-center pt-20 bg-dot-white/[0.2]">
            ...
            <div className="hidden md:flex absolute pointer-events-none inset-0 items-center justify-center dark:bg-black bg-white [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)]"></div>
