    ...
    return (
        <div className="h-dvh flex items-center justify-center pt-20 bg-dot-white/[0.2]">
            ...
            <div className="max-w-[55rem] w-full flex flex-col items-center gap-5 px-5">
                ...
                <p className="text-center text-textSecondary max-w-[40rem] text-sm">
                    Elevate Your Marketing Strategies to New Heights: Empower
                    Your Campaigns with the Cutting-Edge Capabilities of AI
                    Automation and Maximizing Impact.
                </p>
                <Link
                    href={`/tiktok-to-article`}
                    className="text-sm px-5 py-4 bg-primary rounded-full font-medium hover:bg-primary/80 hover:scale-105 transition-all duration-300 ease-in-out delay-0"
                >
                    Get Started
                </Link>
            </div>
