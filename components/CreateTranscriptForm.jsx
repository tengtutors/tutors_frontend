                        ...
                        <>
                            ...
                            {(link || message) && (
                                <button
                                    ...
                                    className={`w-full text-textPrimary rounded-md bg-baseSecondary h-12 font-medium hover:bg-baseSecondaryHover`}
                                >
                                    Upload New Video
                                </button>
                            )}
                            ...
                            {link && (
                                <div className="flex flex-col gap-2">
                                    <button
                                        ...
                                        className={`w-full text-textPrimary rounded-md bg-green-700 h-12 font-medium hover:bg-green-900`}
                                    >
                                        Download
                                    </button>
                                </div>
